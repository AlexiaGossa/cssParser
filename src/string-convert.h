...
#ifndef zM_STRING_CONVERT_HEADER
#define zM_STRING_CONVERT_HEADER
...
int string_UTF8_encodeFromUTF32         ( uint32_t * pdwInputUTF32,     int             iInputLength,           char *  pszOutputUTF8 );
